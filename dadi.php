...
try
 ...
 $ig_info       = $ig->people->getInfoById($idcok);
    $cek_tl = $ig_info->getUser()->getMediaCount();
 if($private == false && $cek_tl !== 0){
			if (($info->getFollowing()) == false)
			    ...
			    echo "akun e di private cok  opo timeline e kosong skip wae ya . \n";
			}
			}
